...
if [ ! -z "$PHP_DATABASE_HOST" ]; then sed -i "s/DATABASE_HOST/$PHP_DATABASE_HOST/" /app/public/paggr-web/application/config/database.php; fi
if [ ! -z "$PHP_DATABASE_USER" ]; then sed -i "s/DATABASE_USER/$PHP_DATABASE_USER/" /app/public/paggr-web/application/config/database.php; fi
if [ ! -z "$PHP_DATABASE_PASS" ]; then sed -i "s/DATABASE_PASS/$PHP_DATABASE_PASS/" /app/public/paggr-web/application/config/database.php; fi
