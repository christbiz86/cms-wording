							...
							<table id="example1" class="table table-bordered table-striped">
								...
								<?php foreach($object as $row => $value){ ?>
									<tr>
										...
										<td>
											<a href="<?=site_url('wording/buy_note/edit/'.$row)?>">
												<button type="button" class="btn btn-block btn-warning btn-sm">Edit</button>
											</a><br>
											<a href="<?=site_url('wording/buy_note/delete/'.$row)?>" onclick="return confirm('Are you sure you want to delete this item?');">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form role="form" method="post" action="<?=site_url('wording/buy_note/add')?>">
					<div class="card-body">
