				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h3 class="card-title">Wording - List Sub Group</h3>
						</div>
						<!-- /.card-header -->
						<div class="card-body">
				...
				<form role="form" method="post" action="<?=site_url('wording/list_sub_group/add')?>">
					<div class="card-body">
						<div class="form-group">
							...
							<input type="text" required class="form-control" id="name" name="name" placeholder="Enter sub group name">
						</div>
						<div class="form-group">
							<label for="id">Sub Group ID</label>
							<input type="text" required class="form-control" id="id" name="id" placeholder="Enter sub group ID">
						</div>
						<div class="form-group">
