				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h3 class="card-title">Wording - List Error Code</h3>
						</div>
						<!-- /.card-header -->
						<div class="card-body">
							...
							<table id="example1" class="table table-bordered table-striped">
								...
								<?php foreach($object as $row => $value){ ?>
									<tr>
										...
										<td>
											<a href="<?=site_url('wording/error_code/edit/'.$row)?>">
												<button type="button" class="btn btn-block btn-warning btn-sm">Edit</button>
											</a><br>
											<a href="<?=site_url('wording/error_code/delete/'.$row)?>" onclick="return confirm('Are you sure you want to delete this item?');">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form role="form" method="post" action="<?=site_url('wording/error_code/add')?>">
					<div class="card-body">
						<div class="form-group">
							<label for="name">ID</label>
							<input type="text" required class="form-control" id="name" name="name" placeholder="Enter error code">
						</div>
						<div class="form-group">
