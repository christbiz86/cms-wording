								...
								<?php foreach($object as $row => $value){ ?>
									<tr>
										...
										<td><?php
											...
											?></td>
										<td>
											<a href="<?=site_url('packages/list_packages/edit/'.$row)?>">
												<button type="button" class="btn btn-block btn-warning btn-sm">Edit</button>
											</a><br>
											<a href="<?=site_url('packages/list_packages/delete/'.$row)?>" onclick="return confirm('Are you sure you want to delete this item?');">
