				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h3 class="card-title">Wording - Buy Note</h3>
						</div>
						<!-- /.card-header -->
						<div class="card-body">
							...
							<table id="example1" class="table table-bordered table-striped">
								...
								<?php foreach($object as $row => $value){ ?>
									<tr>
										...
										<td>
											<a href="<?=site_url('packages/buy_note/edit/'.$row)?>">
												<button type="button" class="btn btn-block btn-warning btn-sm">Edit</button>
											</a><br>
											<a href="<?=site_url('packages/buy_note/delete/'.$row)?>" onclick="return confirm('Are you sure you want to delete this item?');">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Add - Buy Note</h4>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<form role="form" method="post" action="<?=site_url('packages/buy_note/add')?>">
					<div class="card-body">
